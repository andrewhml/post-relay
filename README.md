...
- controlled single-image Meta publish validation CLI with dry-run planning, approval guards, container creation/status polling/publish execution, and sanitized attempt logging
