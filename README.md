...
## Immediate goals
1. Use numbered contact sheets plus `drafts media-plan` / `drafts media-edit` to explicitly choose lead/cover, keep/remove photos, and revise local post type before approval
