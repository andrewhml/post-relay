...
.venv/bin/post-relay agent scheduled-checkin --db data/post_relay.sqlite --cron-output
.venv/bin/post-relay agent scheduled-checkin --db data/post_relay.sqlite --weekly-checkin --cron-output
